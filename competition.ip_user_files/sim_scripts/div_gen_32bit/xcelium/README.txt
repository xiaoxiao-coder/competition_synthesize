...
#
# Generated by export_simulation on Sun Nov 10 16:29:51 +0800 2019
#
################################################################################
...
'-reset_run' switch to the './div_gen_32bit.sh' script.

./div_gen_32bit.sh -reset_run
...
./div_gen_32bit.sh -noclean_files

For more information on the script, please type './div_gen_32bit.sh -help'.
